...
module "average_dev_web" {
  ...
  bucket_name     = "average-dev-web-prod"
...
# GitHub Actions OIDC Role for Prod
resource "aws_iam_role" "github_actions" {
  name = "github-actions-deploy-web-prod"
    ...
    Statement = [
      {
        ...
        Condition = {
          StringLike = {
            "token.actions.githubusercontent.com:sub": "repo:christiankaseburg/average.dev:ref:refs/heads/main"
          }
          StringEquals = {
    ...
    Statement = [
      {
        ...
        Effect   = "Allow"
        Resource = [
          "arn:aws:s3:::average-dev-web-prod",
          "arn:aws:s3:::average-dev-web-prod/*"
        ]
      },
      {
