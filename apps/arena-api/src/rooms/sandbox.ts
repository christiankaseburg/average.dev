...
import { WORLD_SIZE, SLOT_DEFAULTS } from '@average.dev/arena-shared';
...
export class SandboxRoom extends Room<{ state: GameState }> {
  ...
  onCreate(options: ArenaRoomOptions) {
    ...
    this.gameLoop = new GameLoop(false, (eventName, data) => {
